...
import { Professional } from '@/domain/entitites/professional';
import { IEducationLevel } from '@/domain/entitites/utils/educational-level.interface';
...
import { IReferralCode } from '@/domain/entitites/utils/referral-code.interface';
