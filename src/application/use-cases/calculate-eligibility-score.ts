...
import * as educationLevelsData from '@/infrastructure/sample-data/education-levels.mock.json';
...
import * as referralCodeData from '@/infrastructure/sample-data/referral-codes.mock.json';
